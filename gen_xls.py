...
def covering_up_asset_quality(template_path: str, data_path: str, result_path: str, date_str: str) -> None:
    ...
    src_path = os.path.join(data_path, '资产质量.xlsx')
    orders = [
...
def bank_data_tables(template_path: str, data_path: str, result_path: str, date_str: str,
    ...
    data = [
        ...
        [src_list[2], wb_tgt, 2, 'A6', date_str, 'A2', orders[2], ['E5'], ['A6', 'B6', 'C6', 'F6', 'G6'], orders[2][0],
         0],
        [src_list[3], wb_tgt, 3, 'A6', date_str, 'A2', orders[3], ['G5'], ['A6', 'B6', 'C6', 'H6','I6'], orders[3][0],
         0],
        [src_list[4], wb_tgt, 4, 'A6', date_str, 'A2', orders[4], ['F5'], ['A6', 'B6', 'C6', 'F6', 'G6'],
         orders[4][0], 0],
        [src_list[5], wb_tgt, 5, 'A6', date_str, 'A2', orders[5], ['F5', 'G5'], ['A6', 'B6', 'C6', 'G6'],
         orders[5][0], 0],
